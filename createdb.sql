...
ALTER TABLE cast_documentary_role ADD CONSTRAINT cast_documentary_role_pk PRIMARY KEY ( role_id,
                                                                                        cast_documentary_id );
...
ALTER TABLE membership ADD CONSTRAINT membership_pk PRIMARY KEY ( id );
...
ALTER TABLE cast_documentary
    ADD CONSTRAINT cast_doc_artist_fk FOREIGN KEY ( artist_id )
        REFERENCES artist ( id );

ALTER TABLE cast_documentary
    ADD CONSTRAINT cast_doc_doc_fk FOREIGN KEY ( documentary_id )
        REFERENCES documentary ( id );

ALTER TABLE cast_documentary_role
    ADD CONSTRAINT cast_doc_role_cast_doc_fk FOREIGN KEY ( cast_documentary_id )
        REFERENCES cast_documentary ( id );

ALTER TABLE cast_documentary_role
    ADD CONSTRAINT cast_doc_role_role_fk FOREIGN KEY ( role_id )
        REFERENCES role ( id );
...
ALTER TABLE cast_movie_role
    ADD CONSTRAINT cast_movie_role_cast_movie_fk FOREIGN KEY ( cast_movie_id )
...
ALTER TABLE cast_serie_role
    ADD CONSTRAINT cast_serie_role_cast_serie_fk FOREIGN KEY ( cast_serie_id )
...
ALTER TABLE client
    ADD CONSTRAINT client_account_status_fk FOREIGN KEY ( account_status_id )
...
ALTER TABLE documentary
    ADD CONSTRAINT doc_docuserie_fk FOREIGN KEY ( docuserie_id )
        REFERENCES docuserie ( id );

ALTER TABLE documentary_format
    ADD CONSTRAINT doc_form_doc_fk FOREIGN KEY ( documentary_id )
        REFERENCES documentary ( id );

ALTER TABLE documentary_format
    ADD CONSTRAINT doc_form_format_fk FOREIGN KEY ( format_id )
        REFERENCES format ( id );

ALTER TABLE documentary_genre
    ADD CONSTRAINT doc_gen_doc_fk FOREIGN KEY ( documentary_id )
        REFERENCES documentary ( id );

ALTER TABLE documentary_genre
    ADD CONSTRAINT doc_gen_genre_fk FOREIGN KEY ( genre_id )
        REFERENCES genre ( id );

ALTER TABLE documentary_language
    ADD CONSTRAINT doc_lang_doc_fk FOREIGN KEY ( documentary_id )
        REFERENCES documentary ( id );

ALTER TABLE documentary_language
    ADD CONSTRAINT doc_lang_language_fk FOREIGN KEY ( audio_id )
        REFERENCES language ( id );

ALTER TABLE documentary_language
    ADD CONSTRAINT doc_lang_language_fkv2 FOREIGN KEY ( subtitles_id )
        REFERENCES language ( id );

ALTER TABLE documentary
    ADD CONSTRAINT doc_rated_fk FOREIGN KEY ( rated_id )
        REFERENCES rated ( id );
...
ALTER TABLE download_documentary
    ADD CONSTRAINT down_doc_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( id );

ALTER TABLE download_documentary
    ADD CONSTRAINT down_doc_doc_lang_fk FOREIGN KEY ( documentary_language_id )
        REFERENCES documentary_language ( id );

ALTER TABLE download_documentary
    ADD CONSTRAINT down_doc_state_fk FOREIGN KEY ( state_id )
        REFERENCES state ( id );
...
ALTER TABLE download_movie
    ADD CONSTRAINT download_movie_movie_lang_fk FOREIGN KEY ( movie_language_id )
...
ALTER TABLE download_serie
    ADD CONSTRAINT download_serie_serie_lang_fk FOREIGN KEY ( serie_language_id )
...
ALTER TABLE membership
    ADD CONSTRAINT membership_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( id );
...
ALTER TABLE movie_language
    ADD CONSTRAINT movie_lang_language_fk FOREIGN KEY ( subtitles_id )
        REFERENCES language ( id );

ALTER TABLE movie_language
    ADD CONSTRAINT movie_lang_language_fkv2 FOREIGN KEY ( audio_id )
        REFERENCES language ( id );
...
ALTER TABLE reproduction_documentary
    ADD CONSTRAINT repr_doc_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( id );

ALTER TABLE reproduction_documentary
    ADD CONSTRAINT repr_doc_doc_lang_fk FOREIGN KEY ( documentary_language_id )
        REFERENCES documentary_language ( id );

ALTER TABLE reproduction_documentary
    ADD CONSTRAINT repr_doc_state_fk FOREIGN KEY ( state_id )
        REFERENCES state ( id );

ALTER TABLE reproduction_movie
    ADD CONSTRAINT repr_movie_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( id );

ALTER TABLE reproduction_movie
    ADD CONSTRAINT repr_movie_movie_lang_fk FOREIGN KEY ( movie_language_id )
        REFERENCES movie_language ( id );

ALTER TABLE reproduction_movie
    ADD CONSTRAINT repr_movie_state_fk FOREIGN KEY ( state_id )
        REFERENCES state ( id );

ALTER TABLE reproduction_serie
    ADD CONSTRAINT repr_serie_client_fk FOREIGN KEY ( client_id )
        REFERENCES client ( id );

ALTER TABLE reproduction_serie
    ADD CONSTRAINT repr_serie_serie_lang_fk FOREIGN KEY ( serie_language_id )
        REFERENCES serie_language ( id );

ALTER TABLE reproduction_serie
    ADD CONSTRAINT repr_serie_state_fk FOREIGN KEY ( state_id )
        REFERENCES state ( id );
...
ALTER TABLE serie_language
    ADD CONSTRAINT serie_lang_language_fk FOREIGN KEY ( audio_id )
        REFERENCES language ( id );

ALTER TABLE serie_language
    ADD CONSTRAINT serie_lang_language_fkv2 FOREIGN KEY ( subtitles_id )
        REFERENCES language ( id );
